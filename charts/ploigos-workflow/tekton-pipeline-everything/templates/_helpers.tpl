...
*/}}
{{- define "ploigos-workflow-tekton-pipeline-everything.name" -}}
...
*/}}
{{- define "ploigos-workflow-tekton-pipeline-everything.fullname" -}}
...
*/}}
{{- define "ploigos-workflow-tekton-pipeline-everything.chart" -}}
...
helm.sh/chart: {{ include "ploigos-workflow-tekton-pipeline-everything.chart" . }}
