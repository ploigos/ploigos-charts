...
*/}}
{{- define "ploigos-workflow-tekton-pipeline.name" -}}
...
*/}}
{{- define "ploigos-workflow-tekton-pipeline.fullname" -}}
...
*/}}
{{- define "ploigos-workflow-tekton-pipeline.chart" -}}
...
helm.sh/chart: {{ include "ploigos-workflow-tekton-pipeline.chart" . }}
